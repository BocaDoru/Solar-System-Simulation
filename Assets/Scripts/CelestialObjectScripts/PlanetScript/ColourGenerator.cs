...
public class ColourGenerator
{
    ...
    public float BiomePercentFromPoint(Vector3 pointOnUnitSphere)
    {
        ...
        heightPercent += (biomeNoiseFilter.Evaluate(pointOnUnitSphere) - settings.biomeColourSettings.noiseOffset) * settings.biomeColourSettings.noiseStrenght;
        float biomeIndex = 0;
        int numBiome = settings.biomeColourSettings.biomes.Length;
        ...
        return biomeIndex / Mathf.Max(1, numBiome - 1);
    }
